 ...
 */
  jQuery.Callbacks = function(options) {
    ...
    options = typeof options === "string"
      ...
      : jQuery.extend({}, options); // Flag to know if list is currently firing
    var firing,
          ...
          then: function(onFulfilled, onRejected, onProgress) {
            ...
            return jQuery.Deferred(function(newDefer) {
              ...
              tuples[0][3].add(resolve(
                0, newDefer, isFunction(onProgress)
                ? onProgress
                : Identity,
              newDefer.notifyWith));
              ...
              tuples[1][3].add(resolve(
                0, newDefer, isFunction(onFulfilled)
                ? onFulfilled
                : Identity));

              // rejected_handlers.add( ... )
              tuples[2][3].add(resolve(
                0, newDefer, isFunction(onRejected)
                ? onRejected
                : Thrower));
            }).promise();
          },
  ...
  function manipulationTarget(elem, content) {
    if (nodeName(elem, "table") && nodeName(
      content.nodeType !== 11
      ? content
      : content.firstChild,
    "tr")) {
